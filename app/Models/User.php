...
class User extends Authenticatable
{
    ...
    protected $fillable = ['department_id', 'name', 'email', 'password', 'role', 'account_type', 'access_scope', 'approver_type', 'is_approved', 'approved_at', 'email_verified_at', 'signature_data', 'signature_updated_at', 'signature_updated_by'];
    protected $hidden = ['password', 'remember_token'];
    protected $casts = ['email_verified_at' => 'datetime', 'approved_at' => 'datetime', 'signature_updated_at' => 'datetime', 'is_approved' => 'boolean'];
