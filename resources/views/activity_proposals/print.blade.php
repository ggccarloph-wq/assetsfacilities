...
<div id="proposal-print" class="surface p-4 proposal-print">
    ...
    <div class="signature-grid">
      ...
      <div class="signature-card">
        ...
        <div class="signature-name">{{ $person->display_name ?? 'N/A' }}</div>
...
<style>
.proposal-print{max-width:1000px;margin:0 auto}.print-kv{width:100%;border-collapse:collapse;font-size:12px}.print-kv th,.print-kv td{border:1px solid #9b9797;padding:8px;vertical-align:top}.print-kv th{width:18%;background:#eae9e9}.print-section-title{font-size:14px;margin:20px 0 10px}.signature-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.signature-card{border:1px solid #bab6b6;padding:10px;text-align:center;min-height:145px}.signature-role{font-size:10px;font-weight:700;text-transform:uppercase}.signature-image{height:65px;display:flex;align-items:center;justify-content:center}.signature-image img{max-width:100%;max-height:62px;object-fit:contain}.signature-image span{font-size:9px;color:#605d5d}.signature-name{font-size:11px;font-weight:700;border-top:1px solid #201e1d;padding-top:4px}.signature-date{font-size:9px;color:#444141}.print-footer{text-align:center;font-size:9px;margin-top:18px;color:#444141}
