...
<head>
    ...
    <style>
        ...
        .form-control{min-height:48px;border:2px solid #839BBC;background:#F9FBFE;color:#14243C;font-weight:600;border-radius:11px}
        ...
        .form-control[readonly]{background:#E7EDF5;border-color:#B9C7D8;color:#4C607A}
