...
<head>
    ...
    <style>
        ...
        .form-control,.form-select{min-height:48px;border:2px solid #839BBC;background:#F9FBFE;color:#14243C;font-weight:600;border-radius:11px}
        .form-control::placeholder{color:#73849C;opacity:1}
        .form-control:focus,.form-select:focus{background:#fff;border-color:#174F9E;box-shadow:0 0 0 4px rgba(23,79,158,.15)}
        .box{border-color:#CCD8E7;background:#F4F7FB}
        @media (max-width:991.98px){
            body{display:block;min-height:100dvh;padding:14px 10px}
            .card-wrap{width:100%;max-width:760px;margin:0 auto;border-radius:18px}
            .left-pane{height:auto;padding:24px 20px}
            .left-pane h1{font-size:22px}
            .right-pane{padding:20px}
        }
        @media (max-width:575.98px){
            body{padding:0;background:var(--navy-900)}
            .card-wrap{max-width:none;min-height:100dvh;border-radius:0;border:0}
            .left-pane{padding:22px 16px}
            .left-pane h1{font-size:20px}
            .left-pane p{font-size:12.5px}
            .step{padding:11px 12px;font-size:12px}
            ...
            .btn-main{width:100%;min-height:46px}
        }
                ...
                <div class="box mb-0">
                    ...
                    <form method="POST" action="{{ route('register.submit') }}" id="registrationForm" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            @if(($verifiedVoucher['voucher_type'] ?? null) === 'approver')
                            <div class="col-12" id="approverSignatureSection">
                                <div class="border rounded-3 p-3" style="background:#fff">
                                    <div class="fw-bold mb-1">Required e-signature</div>
                                    <div class="muted mb-3">This signature will be locked after account creation and will appear beside your printed name on approved proposals and receipts.</div>
