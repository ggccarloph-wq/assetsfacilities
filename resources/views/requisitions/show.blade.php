            ...
            <li class="{{ $requisition->deanApprover ? 'signed' : 'pending' }}">
                ...
                <div class="step-row">
                    <div>
                        ...
                        <div class="step-name">{{ $requisition->deanApprover->name ?? $requisition->selectedDeanApprover->name ?? 'Awaiting approval' }}</div>
                    </div>
            ...
            <li class="{{ $requisition->executiveApprover ? 'signed' : 'pending' }}">
                ...
                <div class="step-row">
                    <div>
                        ...
                        <div class="step-name">{{ $requisition->executiveApprover->name ?? $requisition->selectedExecutiveApprover->name ?? 'Awaiting approval' }}</div>
                    </div>
