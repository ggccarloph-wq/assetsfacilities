        ...
        @forelse($pendingQueue as $reservation)
            <div class="request-card">
                <div class="d-flex justify-content-between align-items-start gap-2 flex-wrap">
                    <div>
                        <div class="d-flex align-items-center gap-2 flex-wrap"><div style="font-weight:700;font-size:13px">{{ $reservation->title }}</div><span class="status pending">{{ $reservation->displayStatus() }}</span></div>
