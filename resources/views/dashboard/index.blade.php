...
{{-- Recent Requisitions now stands alone (the Activity Proposals panel was
     removed from Asset Management), so it spans the full width instead of
     sitting in a half-width 2-column grid. --}}
